...
class StockTrade(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            df_total_value.to_csv('results/trade_{}_{}.csv'.format(self.model_name, self.iteration))
            ...
            print("total_reward:{}".format(self.state[0]+sum(np.array(self.state[1:(number_of_total_stocks+1)])*np.array(self.state[(number_of_total_stocks+1):(number_of_total_stocks*2+1)]))- self.asset_memory[0] ))
    ...
    def reset(self):  
        if self.initial:
            ...
            sum(np.array(self.previous_state[1:(number_of_total_stocks+1)])*np.array(self.previous_state[(number_of_total_stocks+1):(number_of_total_stocks*2+1)]))
            ...
            self.state = [ self.previous_state[0]] + \
                          self.data.AdjClose.values.tolist() + \
                          self.previous_state[(number_of_total_stocks+1):(number_of_total_stocks*2+1)]+ \
                          self.data.macd.values.tolist() + \
                          self.data.rsi.values.tolist()  + \
                          self.data.cci.values.tolist()  + \
                          self.data.adx.values.tolist() 
